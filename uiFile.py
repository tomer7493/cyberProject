...
"")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(17, 17, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        uiActions.buttons_actions(self.sendFile,self.lock,self.startShareScreen,self.stopShareScreen,self.turnOffStudentPC,self.turnStudentPCOn,self.unlock,self.watchStudentScreen,self.pushButton1,self.listWidget)
